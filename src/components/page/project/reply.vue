<template>
  <div class="posFull pdlr10" v-loading="isLoading" style="top: 40px;">
              ...
              <div v-for="(item, index) in tabs.calc.h" :key="index">
                ...
                <el-row>
                  ...
                  <el-col :span="24">
                    ...
                    <span class="mgl20">投诉类型：{{item.aa | filterNull}}</span>
                    <span class="mgl20">存在问题：{{item.ab | filterNull}}</span>
                  </el-col>
                  <el-col :span="24">
                    <div class="dflex">
                      <div>情况说明：</div>
    ...
    <div class="detail-footer tr">
      <el-button type="primary" @click="save(false)">回 复</el-button>
  ...
  methods: {
    ...
    save(isSaveAsDraft = false) {
      ...
      this.$utils.mock(this.$utils.CONFIG.api.terminateOrPauseOrder, (res) =>  {
        ...
        this.isLoading = false;
        this.$utils.showTip('success', 'success', isSaveAsDraft ? '102' : '112');
        this.back();
