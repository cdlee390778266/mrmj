<template>
  <div>
    ...
    <div class="main">
      <div class="msg">
        <div class="msg-wrapper mgt10">
          <span>客户：</span>
          <el-select v-model="form.name" size="mini" style="width: 140px;">
            <el-option label="模具零件" value="0"></el-option>
            <el-option label="整体模具" value="1"></el-option>
          </el-select>
          <span class="mgl20">模具号：</span>
          <el-select v-model="form.name" size="mini" style="width: 140px;">
            <el-option label="模具零件" value="0"></el-option>
            <el-option label="整体模具" value="1"></el-option>
          </el-select>
          <span class="mgl20">要求交期：</span>
          <el-select v-model="form.name" size="mini" style="width: 140px;">
            <el-option label="模具零件" value="0"></el-option>
            <el-option label="整体模具" value="1"></el-option>
          </el-select>
          <span class="mgl20">手动增加原因：</span>
          <el-select v-model="form.name" size="mini" style="width: 140px;">
            <el-option label="重置" value="0"></el-option>
            <el-option label="销售订单变更" value="1"></el-option>
