                  ...
                  <div class="mgt10 ">
                    ...
                    <div class="filter-item">
                      ...
                      <el-checkbox-group v-model="left.tabs[0].form.inspectionResult" style="display: inline-block;">
                        ...
                        <el-checkbox :label="40">特采</el-checkbox>
                      </el-checkbox-group>
                    </div>
    ...
    methods: {
      queryOrder() { //采购到货不良品查询
        ...
        let params = {
          ...
          mouldNo: this.left.tabs[0].form.module ? this.left.tabs[0].form.module.mouldNo : '',
      ...
      queryProcesses() { //工序完工不良品查询
        ...
        let params = {
          ...
          mouldNo: this.left.tabs[1].form.module ? this.left.tabs[1].form.module.mouldNo : '', 
