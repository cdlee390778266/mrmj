              ...
              <el-row>
                ...
                <el-col :span="24">
                  <el-table
                    ...
                    <el-table-column prop="l" label="处理方式" sortable width="100" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="m" label="处理说明" sortable min-width="120" show-overflow-tooltip></el-table-column>
                  </el-table>
                </el-col>
              </el-row>
            </el-scrollbar>
              ...
              <el-row>
                ...
                <el-col :span="24">
                  <el-table
                    ...
                    <el-table-column prop="h" label="异常概况" min-width="120" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="i" label="处理方式" width="100" show-overflow-tooltip></el-table-column>
                    <el-table-column prop="j" label="处理说明" min-width="120" show-overflow-tooltip></el-table-column>
                  </el-table>
                </el-col>
              </el-row>
            </el-scrollbar>
