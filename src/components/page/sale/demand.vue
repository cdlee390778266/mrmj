  ...
  <div>
    ...
    <div class="main">
      <div class="main-left">
        <div class="main-left-search pd10">
          <div class="mgb10">
            需求列表：
            <el-input v-model="searchText" size="mini" style="width: 200px">
              <i slot="suffix" class="el-input__icon el-icon-search"></i>
            </el-input>
          </div>
          <div>
            <el-button type="primary" size="mini" class @click="dialogAddVisible = true">新增需求</el-button>
            <el-button
              type="primary"
              size="mini"
              class="fr"
              @click="dialogPlanVisible = true"
            >查看生产计划</el-button>
          </div>
        </div>
        <div class="list">
          <div class="list-item pd10 active">
            ...
            <el-row>
              <el-col :span="12">需求类型：模具零件</el-col>
              <el-col :span="12">交期：2019.03.03</el-col>
              <el-col :span="24">报价：2019.03.03</el-col>
    ...
    <el-dialog title="新增客户需求" :visible.sync="dialogAddVisible">
      <el-form :model="addForm" label-width="100px">
        ...
        <div>
          <p>需求明细：</p>
          <el-table :data="addForm.detailList" height="160" border size="mini" style="width: 100%">
    ...
    <el-dialog title="查看当前计划" :visible.sync="dialogPlanVisible">
      <el-table :data="addForm.detailList" border size="mini" style="width: 100%">
        <el-table-column prop="date" label="零件号" width="100"></el-table-column>
        <el-table-column prop="name" label="数量" width="88"></el-table-column>
        <el-table-column prop="address" label="要求交期"></el-table-column>
        <el-table-column prop="address" label="说明"></el-table-column>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogPlanVisible = false">返 回</el-button>
      </div>
    </el-dialog>
